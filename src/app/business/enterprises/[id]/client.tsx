...
export default function BusinessEnterpriseDetailClient({ params: paramsPromise }: { params: Promise<{ id: string }> }) {
  ...
  const enterprise = params ? businessEnterprises.find((e) => e.id === params.id) || businessEnterprises[0] : businessEnterprises[0];
